                        ...
                        <div class = "row justify-content-center">
                            <div class = "col-lg-12"> 
                                <div class = "card border-0 shadow">
                                    <div class = "card-body">
                                    <form action="insert/categoria_insert.php" id="miFormulario2" method="post" role="form2" id="form2" onsubmit="enviarFormulario(event, 'miFormulario2','insert/categoria_insert.php');" novalidate>
                                        <div class= "row g-1">
                                            <div class="col-md-12 form-floating">
                                                <label for="floatingInput">Nombre de la categoria o subcategoria</label>
                                                <input class="form-control" type="text" name="categoria" id="floatingInput" placeholder>
                                                <!-- Mensaje de error para categoria -->
                                            </div>
                                            <div class="col-md-4 form-floating mt-2">
                                                <label for="cprincipal">Categoría principal</label>
                                                <select class="form-control" name="cprin" id="cprincipal" aria-label>
                                                    <option value="0">No</option>
                                                    <option value="1">Si</option>
                                                </select>      
                                            </div>
                                            <div class="col-md-4 form-floating mt-2">
                                                <label for="cpadre">Categoría padre</label>
                                                <select class="form-control" name="cp" id="cpadre" aria-label>
                                                <?php
